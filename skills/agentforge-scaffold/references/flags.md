...
## `agentforge scaffold create` Flags
...
For all available flags, run `agentforge scaffold create --help`.
...
## `agentforge scaffold enhance` Flags
...
For all available flags, run `agentforge scaffold enhance --help`.
