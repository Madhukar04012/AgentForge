...
# Prefer scaffolding over manual code — scaffold a normal `adk` agent; A2A is built in (see /agentforge-scaffold)
...
├── cli/              # ADK CLI internals (used by agentforge playground, eval, etc.)
