...
import agentforge._gcp_project as _gcp_project
import agentforge._project as _project
...
from agentforge.eval.eval_utils import (
    ...
    *,
    ...
    try:
        ...
        if run_name:
            ...
            console.print(
                f"View results using: [bold]agentforge eval results --run-id {run_name}[/bold]"
            )
        else:
...
def cmd_results(
    ...
    try:
        ...
        if results_obj:
            ...
            console.print(
                f"If the run is still in progress, check back later using: [bold]agentforge eval results --run-id {run_id}[/bold]"
            )
