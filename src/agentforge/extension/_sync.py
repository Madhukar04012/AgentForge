...
from agentforge.extension._paths import user_config_root, vendored_extensions_dir
from agentforge.extension._refs import RefParseError, parse_ref
from agentforge.extension._resolver import (
    ResolverError,
    expected_stamp,
    materialize,
    read_stamp,
        ...
        for entry in read_extension_entries(manifest):
            ...
            try:
                ...
                if stale is not None:
                    logging.warning(
                        "Restored extension %r requires agentforge %s but running %s.",
                        entry.name,
