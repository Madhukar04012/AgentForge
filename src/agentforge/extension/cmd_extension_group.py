...
"""agentforge extension command group."""
...
extension_group.add_lazy_command(
    "add",
    "agentforge.extension.cmd_extension_add:cmd_add",
    "Add an extension from a git reference or local path.",
)
extension_group.add_lazy_command(
    "list",
    "agentforge.extension.cmd_extension_list:cmd_list",
    "List active extensions and the commands they contribute.",
)
extension_group.add_lazy_command(
    "update",
    "agentforge.extension.cmd_extension_update:cmd_update",
    "Advance extension pins (re-resolve the tracked ref).",
)
extension_group.add_lazy_command(
    "remove",
    "agentforge.extension.cmd_extension_remove:cmd_remove",
