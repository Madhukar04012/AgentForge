...
from agentforge.extension._paths import git_cache_dir_name, git_cache_root
from agentforge.extension._refs import ExtensionRef
from agentforge.extension._spec import EXTENSION_FILE
...
def _checkout(ref: ExtensionRef, sha: str) -> Path:
    ...
    try:
        ...
        raise ResolverError(
            ...
            "another agentforge process may be resolving extensions."
        ) from e
