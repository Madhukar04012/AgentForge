...
from agentforge.extension._spec import V1ALPHA1, ExtensionManifest
...
def build_json_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "$id": SCHEMA_ID,
        **schema,
        "title": f"agentforge extension manifest ({V1ALPHA1})",
        "description": (
            "Manifest for an agentforge extension. Generated from the CLI's own "
