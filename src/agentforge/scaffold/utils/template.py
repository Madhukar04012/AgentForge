...
from agentforge._project import root_agent_name

from .lock_utils import get_lock_filename, is_empty_agent
from .remote_template import (
    get_base_template_name,
)
from .version import agentforge_version_pin, get_current_version
    ...
    *,
    ...
    Args:
        ...
        overlay_is_project: True when the overlay source is the output project
            itself (--agent local@.), so its agentforge-manifest.yaml is the
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            cookiecutter_config = {
                ...
                "agentforge_version_pin": agentforge_version_pin(),
...
def copy_files(
    ...
    *,
    ...
    Args:
        ...
        skip_manifest: Skip a root agentforge-manifest.yaml. Set when copying a
    ...
    def should_skip(path: pathlib.Path) -> bool:
        ...
        if path.is_dir() and path.name == ".template":
            return True
        if skip_manifest and path.name == "agentforge-manifest.yaml":
            return True
