...
|---------|--------------|
| `uvx agentforge infra cicd` | One-command setup of entire CI/CD pipeline + infrastructure |
| `uvx agentforge scaffold upgrade` | Auto-upgrade to latest version while preserving customizations |
