...
Agent generated with AgentForge version `{{cookiecutter.package_version}}`
...
4. **Deploy:** Set up and initiate the CI/CD pipelines, customizing tests as necessary. Refer to the [deployment section](#deployment) for comprehensive instructions. For streamlined infrastructure deployment, simply run `uvx agentforge infra cicd`. Currently supports GitHub with both Google Cloud Build and GitHub Actions as CI/CD runners.
