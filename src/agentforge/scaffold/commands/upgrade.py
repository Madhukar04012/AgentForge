...
from agentforge._project import find_project_config, find_project_root
...
def upgrade(
    ...
    if not metadata:
        console.print("[bold red]Error:[/bold red] No agentforge metadata found.")
        console.print("Ensure agentforge-manifest.yaml exists in your project root.")
        raise SystemExit(1)
    ...
    if not old_version:
        ...
        console.print(
            ...
            "Please ensure agentforge-manifest.yaml has acli_version set."
        )
        raise SystemExit(1)
    ...
    if not success:
        console.print(
            f"[bold red]Error:[/bold red] Could not fetch agentforge@{old_version} "
