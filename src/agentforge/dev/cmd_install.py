...
"""AgentForge install command — install project dependencies."""
...
from agentforge.scaffold.utils.language import dispatch_language
...
def cmd_install(clean: bool, locked: bool):
    ...
    # Never advances pins.
    from agentforge.extension._sync import sync_extensions
