...
from agentforge._project import chdir_project_root, read_project_config
from agentforge._tools import (
    ToolNotFoundError,
    require_tool,
)
from agentforge.infra._cicd_utils import (
    ProjectConfig,
...
def get_project_name_from_config() -> str | None:
    """Get project name from agentforge-manifest.yaml.
    ...
    *,
    ...
    if not (tf_dir / "variables.tf").exists():
        ...
        console.print(
            ...
            "  [cyan]agentforge scaffold enhance[/]\n"
        )
        raise SystemExit(1)
