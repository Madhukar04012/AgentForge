...
"""agentforge infra show — read the provisioned infrastructure's outputs."""
...
from agentforge.infra._terraform import (
...
def cmd_infra_show(as_json: bool, include_sensitive: bool) -> None:
    ...
    \b
    Reads the values `agentforge infra single-project --apply` provisioned —
    ...
    if not values:
        ...
        click.echo("    agentforge infra single-project --apply")
        return
