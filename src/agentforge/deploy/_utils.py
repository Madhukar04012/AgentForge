...
if TYPE_CHECKING:
    from agentforge._project import ProjectConfig
...
DEFAULT_CPU = "1"
DEFAULT_MEMORY = "4Gi"
# Scale to zero by default: `agentforge deploy` is the iteration path, and idle
...
def validate_deployment_region(
    ...
    if not re.match(r"^[a-z]+-[a-z]+\d+$", normalized):
        ...
        raise click.ClickException(
            ...
            "  Please specify a valid Google Cloud Platform region (e.g., 'us-central1', 'europe-west4', 'asia-northeast1') via --region or in agentforge-manifest.yaml.\n"
