...
"""agentforge update command — update skills via npx skills CLI."""

import click

from agentforge._runner import run
from agentforge._tools import run_npx_skills
...
@require_confirmation("This will force-reinstall agentforge skills to all detected IDEs.")
