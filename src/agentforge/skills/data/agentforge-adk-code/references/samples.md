...
curated tier — canonical ADK patterns maintained by the agentforge team.
...
and not curated by the agentforge team, so there is no guaranteed `AGENTS.md` to guide the lift. Check
