...
Activate `/agentforge-workflow` first for required development phases and scaffolding steps.
...
1. Verify project: run `agentforge info` (proceed if config exists).
2. New project: run `agentforge scaffold create <name>`.
3. Existing code: run `agentforge scaffold enhance .`.
