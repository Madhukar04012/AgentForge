...
AgentForge scaffolds, evaluates, and deploys agents from the descriptions you provide to your coding agent. Use it to build:
...
See the [`agentforge-publish`](../reference/skills.md) skill for registration details.
